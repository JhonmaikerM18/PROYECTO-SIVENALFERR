...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Menu->Controls->Add(this->panelLogos);
			...
			// panelLogos
			// 
			this->panelLogos->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((System::Windows::Forms::AnchorStyles::Bottom | System::Windows::Forms::AnchorStyles::Left));
			this->panelLogos->Controls->Add(this->Logo);
			this->panelLogos->Location = System::Drawing::Point(3, 3);
			...
			this->btn_inicio->Location = System::Drawing::Point(3, 102);
			this->btn_inicio->Margin = System::Windows::Forms::Padding(3, 10, 3, 3);
			...
			this->btn_solicitud->Location = System::Drawing::Point(3, 149);
			...
			this->btn_detalles->Location = System::Drawing::Point(3, 196);
			...
			this->btn_usuario->Location = System::Drawing::Point(3, 243);
			...
			this->btn_ajustes->Location = System::Drawing::Point(3, 290);
			...
			this->panelSuperior->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Inicio::arrastraForm);
			// 
			// ctrolMax
			// 
...
private: System::Void ctrolMax_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	//panelLogos->Margin = System::Windows::Forms::Padding(3, 342, 3, 3);
...
private: System::Void arrastraForm(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
}
